---
description: "Optimize content to be cited by AI search engines and LLMs (GEO / AEO / answer engine optimization). Use when you want your website or content surfaced in AI answers, or mentions 'AI SEO', 'AEO', 'GEO', 'AI Overviews', 'optimize for ChatGPT/Perplexity/Claude', 'AI citations', 'AI visibility', 'zero-click search', or 'llms.txt'."
...
**Load the project context first.** If the project has a CLAUDE.md, brand brief, or positioning doc, read it for audience, voice, and differentiation. Use that context and only ask for what's not already covered.
